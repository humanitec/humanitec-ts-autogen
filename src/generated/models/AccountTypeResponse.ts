...
export function AccountTypeResponseFromJSON(json: any): AccountTypeResponse {
    return AccountTypeResponseFromJSONTyped(json, false);
}

export function AccountTypeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountTypeResponse {
    if (json == null) {
        return json;
    }
    return {

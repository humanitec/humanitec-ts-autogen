...
export function DeploymentErrorRequestFromJSON(json: any): DeploymentErrorRequest {
    return DeploymentErrorRequestFromJSONTyped(json, false);
}

export function DeploymentErrorRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeploymentErrorRequest {
    if (json == null) {
        return json;
    }
    return {

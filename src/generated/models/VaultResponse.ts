...
export function VaultResponseFromJSON(json: any): VaultResponse {
    return VaultResponseFromJSONTyped(json, false);
}

export function VaultResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): VaultResponse {
    if (json == null) {
        return json;
    }
    return {

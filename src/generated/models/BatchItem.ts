...
export function BatchItemFromJSON(json: any): BatchItem {
    return BatchItemFromJSONTyped(json, false);
}

export function BatchItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchItem {
    if (json == null) {
        return json;
    }
    return {

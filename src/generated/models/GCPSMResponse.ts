...
export function GCPSMResponseFromJSON(json: any): GCPSMResponse {
    return GCPSMResponseFromJSONTyped(json, false);
}

export function GCPSMResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GCPSMResponse {
    if (json == null) {
        return json;
    }
    return {

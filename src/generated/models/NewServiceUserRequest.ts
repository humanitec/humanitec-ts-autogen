...
export function NewServiceUserRequestFromJSON(json: any): NewServiceUserRequest {
    return NewServiceUserRequestFromJSONTyped(json, false);
}

export function NewServiceUserRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): NewServiceUserRequest {
    if (json == null) {
        return json;
    }
    return {

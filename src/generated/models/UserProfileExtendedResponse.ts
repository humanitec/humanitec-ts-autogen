...
export function UserProfileExtendedResponseFromJSON(json: any): UserProfileExtendedResponse {
    return UserProfileExtendedResponseFromJSONTyped(json, false);
}

export function UserProfileExtendedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserProfileExtendedResponse {
    if (json == null) {
        return json;
    }
    return {

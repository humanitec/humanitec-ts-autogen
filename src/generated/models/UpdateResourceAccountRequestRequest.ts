...
export function UpdateResourceAccountRequestRequestFromJSON(json: any): UpdateResourceAccountRequestRequest {
    return UpdateResourceAccountRequestRequestFromJSONTyped(json, false);
}

export function UpdateResourceAccountRequestRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateResourceAccountRequestRequest {
    if (json == null) {
        return json;
    }
    return {

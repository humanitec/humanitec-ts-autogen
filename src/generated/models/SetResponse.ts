...
export function SetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetResponse {
    ...
    return {
        ...
        'workloads': json['workloads'] == null ? undefined : (mapValues(json['workloads'], WorkloadResponseFromJSON)),
    };
}
...
export function SetResponseToJSONTyped(value?: SetResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'workloads': value['workloads'] == null ? undefined : (mapValues(value['workloads'], WorkloadResponseToJSON)),
    };
}

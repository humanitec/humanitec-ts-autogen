...
export function UpdateArtefactVersionPayloadRequestFromJSON(json: any): UpdateArtefactVersionPayloadRequest {
    return UpdateArtefactVersionPayloadRequestFromJSONTyped(json, false);
}

export function UpdateArtefactVersionPayloadRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateArtefactVersionPayloadRequest {
    if (json == null) {
        return json;
    }
    return {

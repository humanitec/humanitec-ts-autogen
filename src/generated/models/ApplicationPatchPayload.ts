...
export function ApplicationPatchPayloadFromJSON(json: any): ApplicationPatchPayload {
    return ApplicationPatchPayloadFromJSONTyped(json, false);
}

export function ApplicationPatchPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationPatchPayload {
    if (json == null) {
        return json;
    }
    return {

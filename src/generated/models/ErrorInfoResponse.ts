...
export function ErrorInfoResponseFromJSON(json: any): ErrorInfoResponse {
    return ErrorInfoResponseFromJSONTyped(json, false);
}

export function ErrorInfoResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErrorInfoResponse {
    if (json == null) {
        return json;
    }
    return {

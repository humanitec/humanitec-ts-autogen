...
export function GCPAuthRequestFromJSON(json: any): GCPAuthRequest {
    return GCPAuthRequestFromJSONTyped(json, false);
}

export function GCPAuthRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GCPAuthRequest {
    if (json == null) {
        return json;
    }
    return {

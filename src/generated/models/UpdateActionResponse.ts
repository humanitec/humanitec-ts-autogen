...
export function UpdateActionResponseFromJSON(json: any): UpdateActionResponse {
    return UpdateActionResponseFromJSONTyped(json, false);
}

export function UpdateActionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateActionResponse {
    if (json == null) {
        return json;
    }
    return {

...
export function DeploymentPipelineReferenceResponseFromJSON(json: any): DeploymentPipelineReferenceResponse {
    return DeploymentPipelineReferenceResponseFromJSONTyped(json, false);
}

export function DeploymentPipelineReferenceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeploymentPipelineReferenceResponse {
    if (json == null) {
        return json;
    }
    return {

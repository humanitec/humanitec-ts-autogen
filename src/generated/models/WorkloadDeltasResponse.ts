...
/**
 * WorkloadDeltas groups the different operations together.
 * @export
 * @interface WorkloadDeltasResponse
 */
...
export function WorkloadDeltasResponseFromJSON(json: any): WorkloadDeltasResponse {
    return WorkloadDeltasResponseFromJSONTyped(json, false);
}

export function WorkloadDeltasResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkloadDeltasResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'add': (mapValues(json['add'], WorkloadResponseFromJSON)),
        'remove': json['remove'],
    };
}

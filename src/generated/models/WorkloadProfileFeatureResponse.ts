...
export function WorkloadProfileFeatureResponseFromJSON(json: any): WorkloadProfileFeatureResponse {
    return WorkloadProfileFeatureResponseFromJSONTyped(json, false);
}

export function WorkloadProfileFeatureResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkloadProfileFeatureResponse {
    if (json == null) {
        return json;
    }
    return {

...
export function EnvironmentRuntimeInfoResponseFromJSON(json: any): EnvironmentRuntimeInfoResponse {
    return EnvironmentRuntimeInfoResponseFromJSONTyped(json, false);
}

export function EnvironmentRuntimeInfoResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentRuntimeInfoResponse {
    if (json == null) {
        return json;
    }
    return {

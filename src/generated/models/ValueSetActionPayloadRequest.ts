...
export function ValueSetActionPayloadRequestFromJSON(json: any): ValueSetActionPayloadRequest {
    return ValueSetActionPayloadRequestFromJSONTyped(json, false);
}

export function ValueSetActionPayloadRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValueSetActionPayloadRequest {
    if (json == null) {
        return json;
    }
    return {

...
export function UserProfileExtendedRequestFromJSON(json: any): UserProfileExtendedRequest {
    return UserProfileExtendedRequestFromJSONTyped(json, false);
}

export function UserProfileExtendedRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserProfileExtendedRequest {
    if (json == null) {
        return json;
    }
    return {

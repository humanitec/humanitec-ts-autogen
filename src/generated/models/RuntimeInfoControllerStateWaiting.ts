...
export function RuntimeInfoControllerStateWaitingFromJSON(json: any): RuntimeInfoControllerStateWaiting {
    return RuntimeInfoControllerStateWaitingFromJSONTyped(json, false);
}

export function RuntimeInfoControllerStateWaitingFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeInfoControllerStateWaiting {
    if (json == null) {
        return json;
    }
    return {

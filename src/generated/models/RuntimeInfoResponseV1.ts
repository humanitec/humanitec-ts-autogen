...
export function RuntimeInfoResponseV1FromJSON(json: any): RuntimeInfoResponseV1 {
    return RuntimeInfoResponseV1FromJSONTyped(json, false);
}

export function RuntimeInfoResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeInfoResponseV1 {
    if (json == null) {
        return json;
    }
    return {

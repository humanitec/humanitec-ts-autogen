...
export function PipelineRunCreateBodyFromJSON(json: any): PipelineRunCreateBody {
    return PipelineRunCreateBodyFromJSONTyped(json, false);
}

export function PipelineRunCreateBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PipelineRunCreateBody {
    if (json == null) {
        return json;
    }
    return {

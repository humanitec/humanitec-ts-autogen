 ...
 * @enum {string}
 */
export enum WorkloadProfileSpecDefinitionRuntimePropertyType {
    feature = 'feature',
...
export function WorkloadProfileSpecDefinitionRuntimePropertyTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkloadProfileSpecDefinitionRuntimePropertyType {
    return json as WorkloadProfileSpecDefinitionRuntimePropertyType;
}

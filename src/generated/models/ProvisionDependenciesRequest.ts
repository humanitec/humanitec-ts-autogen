...
export function ProvisionDependenciesRequestFromJSON(json: any): ProvisionDependenciesRequest {
    return ProvisionDependenciesRequestFromJSONTyped(json, false);
}

export function ProvisionDependenciesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProvisionDependenciesRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'is_dependent': json['is_dependent'] == null ? undefined : json['is_dependent'],

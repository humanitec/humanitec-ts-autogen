...
export function AzureKVResponseFromJSON(json: any): AzureKVResponse {
    return AzureKVResponseFromJSONTyped(json, false);
}

export function AzureKVResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AzureKVResponse {
    if (json == null) {
        return json;
    }
    return {

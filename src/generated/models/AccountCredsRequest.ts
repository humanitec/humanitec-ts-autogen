...
export function AccountCredsRequestFromJSON(json: any): AccountCredsRequest {
    return AccountCredsRequestFromJSONTyped(json, false);
}

export function AccountCredsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountCredsRequest {
    if (json == null) {
        return json;
    }
    return {

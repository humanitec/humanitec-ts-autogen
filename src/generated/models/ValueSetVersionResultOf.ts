 ...
 * @enum {string}
 */
export enum ValueSetVersionResultOf {
...
export function ValueSetVersionResultOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValueSetVersionResultOf {
    return json as ValueSetVersionResultOf;
}

...
export function AzureAuthRequestFromJSON(json: any): AzureAuthRequest {
    return AzureAuthRequestFromJSONTyped(json, false);
}

export function AzureAuthRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AzureAuthRequest {
    if (json == null) {
        return json;
    }
    return {

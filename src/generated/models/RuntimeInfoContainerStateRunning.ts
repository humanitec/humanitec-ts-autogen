...
export function RuntimeInfoContainerStateRunningFromJSON(json: any): RuntimeInfoContainerStateRunning {
    return RuntimeInfoContainerStateRunningFromJSONTyped(json, false);
}

export function RuntimeInfoContainerStateRunningFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeInfoContainerStateRunning {
    if (json == null) {
        return json;
    }
    return {

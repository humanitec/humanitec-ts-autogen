...
import type { AzureAuthRequest } from './AzureAuthRequest.js';
import {
...
export function AzureKVRequestFromJSON(json: any): AzureKVRequest {
    return AzureKVRequestFromJSONTyped(json, false);
}

export function AzureKVRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AzureKVRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'auth': json['auth'] == null ? undefined : AzureAuthRequestFromJSON(json['auth']),

...
export function JSONPatchRequestFromJSON(json: any): JSONPatchRequest {
    return JSONPatchRequestFromJSONTyped(json, false);
}

export function JSONPatchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): JSONPatchRequest {
    if (json == null) {
        return json;
    }
    return {

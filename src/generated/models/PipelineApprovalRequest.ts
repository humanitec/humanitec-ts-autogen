 ...
 */
export function instanceOfPipelineApprovalRequest(value: object): value is PipelineApprovalRequest {
...
export function PipelineApprovalRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PipelineApprovalRequest {
    ...
    return {
        ...
        'approved_at': json['approved_at'] == null ? undefined : (parseDateTime(json['approved_at'])),
    };
}

export function PipelineApprovalRequestToJSON(json: any): PipelineApprovalRequest {
    return PipelineApprovalRequestToJSONTyped(json, false);
}

export function PipelineApprovalRequestToJSONTyped(value?: PipelineApprovalRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'approved_at': value['approved_at'] == null ? value['approved_at'] : serializeDateTime(value['approved_at']),
    };
}

...
export function EnvironmentBaseUpdateRequestFromJSON(json: any): EnvironmentBaseUpdateRequest {
    return EnvironmentBaseUpdateRequestFromJSONTyped(json, false);
}

export function EnvironmentBaseUpdateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentBaseUpdateRequest {
    if (json == null) {
        return json;
    }
    return {

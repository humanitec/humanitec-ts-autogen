 ...
 * @export
 * @interface UpdateResourceClassRequest
 */
...
export function UpdateResourceClassRequestFromJSON(json: any): UpdateResourceClassRequest {
    return UpdateResourceClassRequestFromJSONTyped(json, false);
}

export function UpdateResourceClassRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateResourceClassRequest {
    if (json == null) {
        return json;
    }
    return {

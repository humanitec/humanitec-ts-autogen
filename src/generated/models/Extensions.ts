...
/**
 * A general purpose way of extending the workload described by a Score spec, for the things a Score spec deliberately cannot express because they are compute specific.
 * 
...
export function ExtensionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Extensions {
    ...
    return {
        ...
        'kubernetes': json['kubernetes'] == null ? undefined : json['kubernetes'],
    };
}

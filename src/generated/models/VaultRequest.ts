...
import type { VaultAuthRequest } from './VaultAuthRequest.js';
import {
...
export function VaultRequestFromJSON(json: any): VaultRequest {
    return VaultRequestFromJSONTyped(json, false);
}

export function VaultRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): VaultRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'auth': json['auth'] == null ? undefined : VaultAuthRequestFromJSON(json['auth']),
...
export function VaultRequestToJSON(value?: VaultRequest | null): any {
    ...
    return {
        ...
        'auth': VaultAuthRequestToJSON(value['auth']),
        'path': value['path'],
        'url': value['url'],
    };
}

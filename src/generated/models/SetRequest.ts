...
export function SetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetRequest {
    ...
    return {
        ...
        'workloads': json['workloads'] == null ? undefined : (mapValues(json['workloads'], WorkloadRequestFromJSON)),
    };
}
...
export function SetRequestToJSONTyped(value?: SetRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'workloads': value['workloads'] == null ? undefined : (mapValues(value['workloads'], WorkloadRequestToJSON)),
    };
}

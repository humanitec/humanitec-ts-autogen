...
export function EventBaseResponseFromJSON(json: any): EventBaseResponse {
    return EventBaseResponseFromJSONTyped(json, false);
}

export function EventBaseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBaseResponse {
    if (json == null) {
        return json;
    }
    return {

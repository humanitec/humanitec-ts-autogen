...
export function ModuleDeltasResponseFromJSON(json: any): ModuleDeltasResponse {
    return ModuleDeltasResponseFromJSONTyped(json, false);
}

export function ModuleDeltasResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModuleDeltasResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'add': (mapValues(json['add'], ModuleResponseFromJSON)),
        'remove': json['remove'],
        'update': json['update'],
    };
}

...
export function WorkloadResponseFromJSON(json: any): WorkloadResponse {
    return WorkloadResponseFromJSONTyped(json, false);
}

export function WorkloadResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkloadResponse {
    if (json == null) {
        return json;
    }
    return {

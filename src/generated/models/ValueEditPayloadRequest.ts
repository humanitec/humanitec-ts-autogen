...
export function ValueEditPayloadRequestFromJSON(json: any): ValueEditPayloadRequest {
    return ValueEditPayloadRequestFromJSONTyped(json, false);
}

export function ValueEditPayloadRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValueEditPayloadRequest {
    if (json == null) {
        return json;
    }
    return {

 ...
 * @export
 * @interface WorkloadDeltasRequest
 */
...
export function WorkloadDeltasRequestFromJSON(json: any): WorkloadDeltasRequest {
    return WorkloadDeltasRequestFromJSONTyped(json, false);
}

export function WorkloadDeltasRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkloadDeltasRequest {
    if (json == null) {
        return json;
    }
    return {

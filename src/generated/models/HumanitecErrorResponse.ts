...
export function HumanitecErrorResponseFromJSON(json: any): HumanitecErrorResponse {
    return HumanitecErrorResponseFromJSONTyped(json, false);
}

export function HumanitecErrorResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HumanitecErrorResponse {
    if (json == null) {
        return json;
    }
    return {

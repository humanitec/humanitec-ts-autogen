...
export function VaultAuthRequestFromJSON(json: any): VaultAuthRequest {
    return VaultAuthRequestFromJSONTyped(json, false);
}

export function VaultAuthRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): VaultAuthRequest {
    if (json == null) {
        return json;
    }
    return {

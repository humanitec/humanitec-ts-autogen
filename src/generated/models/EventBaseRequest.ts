...
export function EventBaseRequestFromJSON(json: any): EventBaseRequest {
    return EventBaseRequestFromJSONTyped(json, false);
}

export function EventBaseRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBaseRequest {
    if (json == null) {
        return json;
    }
    return {

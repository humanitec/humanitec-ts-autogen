...
export function UpdateEnvironmentTypePayloadRequestFromJSON(json: any): UpdateEnvironmentTypePayloadRequest {
    return UpdateEnvironmentTypePayloadRequestFromJSONTyped(json, false);
}

export function UpdateEnvironmentTypePayloadRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateEnvironmentTypePayloadRequest {
    if (json == null) {
        return json;
    }
    return {

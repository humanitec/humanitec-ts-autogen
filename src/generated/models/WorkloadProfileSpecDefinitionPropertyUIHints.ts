...
export function WorkloadProfileSpecDefinitionPropertyUIHintsFromJSON(json: any): WorkloadProfileSpecDefinitionPropertyUIHints {
    return WorkloadProfileSpecDefinitionPropertyUIHintsFromJSONTyped(json, false);
}

export function WorkloadProfileSpecDefinitionPropertyUIHintsFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkloadProfileSpecDefinitionPropertyUIHints {
    if (json == null) {
        return json;
    }
    return {

...
export function ArtefactVersionBaseFromJSON(json: any): ArtefactVersionBase {
    return ArtefactVersionBaseFromJSONTyped(json, false);
}

export function ArtefactVersionBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArtefactVersionBase {
    if (json == null) {
        return json;
    }
    return {
